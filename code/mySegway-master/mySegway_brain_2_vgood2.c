...
double var[10] = {3,1,1,0.3,0.2,0.2,0.3,1,1,3};
double s[10] = {0,0,0,0,0,0,0,0,0};
//double mean2[10] = { -1.6,-1,-0.6,-0.2,0,0.2,0.6,1,1.5,2 };
double mean[10] = { -3,-2,-1,-0.8,-0.4,0.4,0.8,1,2,3 };
double mean2[10] = { -2,-1,-0.6,-0.4,-0.1,0.1,0.4,0.6,1,2 };
double var2[10] = { 1,1,1,0.3,0.3,0.3,0.3,1,1,1 };
...
void pid()
{
  ...
  */
  ...
  if (error< 0.5 && error >-0.5) {
	  ...
	  double s[10] = { 0,0,0,0,0,0,0,0,0 };
	  //double mean2[10] = { -1.6,-1,-0.6,-0.2,0,0.2,0.6,1,1.5,2 };
	  double mean[10] = { -3,-2,-1,-0.4,-0.1,0.1,0.4,1,2,3 };
	  double mean2[10] = { -2,-1,-0.6,-0.4,-0.1,0.1,0.4,0.6,1,2 };
