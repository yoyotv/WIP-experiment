...
double mean[10] ={-20,-15,-10,-5,-1,1,5,10,15,20};
double mean2[10] = { -20,-15,-10,-5,-1,1,5,10,15,20 };
...
void pid()
{
	...
	*/
	...
	for (i = 0; i < value; i++) {
		delta_weight_a[i] = -1000*sliding*s[i]; // (error converge much quickly as learning rate minuslearning)
